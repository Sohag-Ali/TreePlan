                ...
                <div className="bg-white rounded-lg shadow-md p-8 w-full max-w-sm shadow-md rounded-xl border border-emerald-100">
                    ...
                    <form onSubmit={handleLogin}  className="flex flex-col gap-4">
                        ...
                        <div className="relative">
                            ...
                            />
                            <span onClick={()=> setShow(!show)} className="absolute right-3 top-10 text-gray-600 cursor-pointer">
                    ...
                    <button   onClick={handleGoogleSignIn}className="btn bg-white text-black border-[#e5e5e5] mt-3 w-full">
                    ...
                    <p className="text-center text-gray-500 mt-4">
                        ...
                        <Link to='/register' href="/signup" className="text-lime-600 font-semibold hover:underline">
                            Sign Up
                        </Link>
                    </p>
                </div>
